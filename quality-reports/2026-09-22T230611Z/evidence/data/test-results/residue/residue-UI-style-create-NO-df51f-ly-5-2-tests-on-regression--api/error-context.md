...
- Name: residue.spec.ts >> UI-style create NOT registered (pattern of whitespace-only / 5.2 tests on regression)
- Location: quality-reports/2026-09-22T230611Z/evidence/data/residue/residue.spec.ts:24:1
...
Expected length: 0
Received length: 1
Received array:  [{"description": "blank res1790118903", "id": 7061, "owner": "buggy", "severity": "LOW", "state": "OPEN", "title": "[e2e] [data]probe unregistered res1790118903"}]
```
