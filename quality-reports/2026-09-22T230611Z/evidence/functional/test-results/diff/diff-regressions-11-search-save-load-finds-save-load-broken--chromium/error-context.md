...
- Name: diff-regressions.spec.ts >> 11 search "save load" finds "save/load broken"
- Location: specs/diff-regressions.spec.ts:96:1
    ...
    - generic [ref=f1e9]:
      - search [ref=f1e10]:
        - textbox "Search bugs by title" [active] [ref=f1e11]:
          ...
          - text: save load broken mudalgfzjvn5
