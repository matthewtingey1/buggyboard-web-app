...
- Name: diff-regressions.spec.ts >> 09 Escape after choosing a severity closes the edit modal and discards
- Location: specs/diff-regressions.spec.ts:22:1
...
```yaml
- 'dialog "Edit bug #7055"':
  - 'heading "Edit bug #7055" [level=2]'
  - button "Close"
  - text: ID
  - textbox "ID": "7055"
  - text: Title
  - textbox "Title": "[functional] esc-sev-edit mudakg7vum4r"
  - text: Severity
  - combobox "Severity"
  - text: State
  - combobox "State"
