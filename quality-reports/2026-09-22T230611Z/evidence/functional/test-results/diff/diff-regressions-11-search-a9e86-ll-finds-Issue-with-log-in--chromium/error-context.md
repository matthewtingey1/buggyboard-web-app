...
- Name: diff-regressions.spec.ts >> 11 search "log in" (space) still finds "Issue with log-in"
- Location: specs/diff-regressions.spec.ts:85:1
...
- generic [ref=f1e3]:
  - banner [ref=f1e4]:
    ...
    - generic [ref=f1e9]:
      - search [ref=f1e10]:
        - textbox "Search bugs by title" [active] [ref=f1e11]:
          - /placeholder: Search bugs…
          - text: log in mudalb1j6cl2
        - button "Clear search" [ref=f1e12] [cursor=pointer]:
          - generic [aria-hidden] [ref=f1e13]: ×
      - button "New Bug" [ref=f1e15] [cursor=pointer]
      - button "Logout" [ref=f1e17] [cursor=pointer]
  - main [ref=f1e18]:
    - generic [ref=f1e19]:
      - group "Filter by bug state" [ref=f1e21]:
        - button "Open" [pressed] [ref=f1e22] [cursor=pointer]
        - button "Closed" [ref=f1e23] [cursor=pointer]
      - status [ref=f1e24]: No bugs matched.
      - region "Bug table" [ref=f1e26]:
        - table "Bugs" [ref=f1e27]:
          - rowgroup [ref=f1e28]:
            - row [ref=f1e29]:
              - columnheader [ref=f1e30]:
                - button "ID" [ref=f1e31] [cursor=pointer]
              - columnheader [ref=f1e33]:
                - button "Severity" [ref=f1e34] [cursor=pointer]:
                  - text: Severity
                  - generic [aria-hidden] [ref=f1e35]: ↓
              - columnheader [ref=f1e36]:
                - button "Title" [ref=f1e37] [cursor=pointer]
              - columnheader [ref=f1e39]:
                - button "Owner" [ref=f1e40] [cursor=pointer]
          - rowgroup [ref=f1e42]:
            - row [ref=f1e43]:
              - cell "No bugs matched." [ref=f1e44]
```
