...
- Name: create-bug/create-bug-plan.spec.ts >> 6.1 A bug created from the Closed view is Open and appears under Open
- Location: tests/create-bug/create-bug-plan.spec.ts:130:1
  ...
  - main [ref=e16]:
    - generic [ref=e17]:
      - group "Filter by bug state" [ref=e19]:
        ...
        - button "Closed" [active] [pressed] [ref=e21] [cursor=pointer]
      - status [ref=e22]: No bugs matched.
