...
- Name: create-bug/create-bug-plan.spec.ts >> 6.2 An active search is kept after creating a bug
- Location: tests/create-bug/create-bug-plan.spec.ts:146:1
...
- generic [ref=e3]:
  - banner [ref=e4]:
    ...
    - generic [ref=e9]:
      - search [ref=e10]:
        - textbox "Search bugs by title" [active] [ref=e11]:
          - /placeholder: Search bugs…
          - text: zzq-mudba5rcp83p
        - button "Clear search" [ref=e12] [cursor=pointer]:
          - generic [aria-hidden] [ref=e13]: ×
      - button "Report Bug" [ref=e15] [cursor=pointer]
      - button "Logout" [ref=e17] [cursor=pointer]
  - main [ref=e18]:
    - generic [ref=e19]:
      - group "Filter by bug state" [ref=e21]:
        - button "Open" [pressed] [ref=e22] [cursor=pointer]
        - button "Closed" [ref=e23] [cursor=pointer]
      - status [ref=e24]: No bugs matched.
      - region "Bug table" [ref=e26]:
        - table "Bugs" [ref=e27]:
          - rowgroup [ref=e28]:
            - row [ref=e29]:
              - columnheader [ref=e30]:
                - button "ID" [ref=e31] [cursor=pointer]
              - columnheader [ref=e33]:
                - button "Severity" [ref=e34] [cursor=pointer]:
                  - text: Severity
                  - generic [aria-hidden] [ref=e35]: ↓
              - columnheader [ref=e36]:
                - button "Title" [ref=e37] [cursor=pointer]
              - columnheader [ref=e39]:
                - button "Owner" [ref=e40] [cursor=pointer]
          - rowgroup [ref=e42]:
            - row [ref=e43]:
              - cell "No bugs matched." [ref=e44]
```
